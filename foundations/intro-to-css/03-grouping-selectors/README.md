...
- Does each element have a unique class name?yes, they do
- Did you use the grouping selector for styles that both elements share?yes, I did
- Did you make separate rules for the styles unique to each element?yes, I did
